...
def values_greater_than_second(original_list):
    new_list = []
    for list_item in range(len(original_list)):
        # print(original_list[list_item])
        if len(original_list) < 2:
            # print("False")
            return(False)
        elif original_list[list_item] > original_list[1]:
            new_list.append(original_list[list_item])
    print(len(new_list))
    print(new_list)
    return(new_list)    
